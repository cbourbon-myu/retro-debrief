...
(function(){if(!window.RETRO_TEMPLATES)window.RETRO_TEMPLATES={};window.RETRO_TEMPLATES["starwars"]={
  ...
  "reglesBorderWidth": 0,
  "reglesOverlayMobile": "linear-gradient(to right, rgba(10,12,16,1) 0%, rgba(0,0,0,1) 36%, rgba(0,0,0,1) 45%, rgba(10,12,16,0) 100%)",
  ...
  "fin": {
    ...
    "low": {
      "text": "Le Côté Obscur a tenté de nous séduire, mais nous sommes toujours debout. Que la Force guide notre prochain sprint.",
      "emoji": "🌑⚔️"
    },
    "mid": {
      "text": "L'équilibre dans la Force a été maintenu. Continuez votre entraînement, Padawans. Le prochain sprint nous attend.",
      "emoji": "⚔️✨"
    },
    "high": {
      "text": "La Force était puissante dans ce sprint. Le Conseil salue votre maîtrise, jeunes Jedi. Rendez-vous dans la prochaine galaxie.",
      "emoji": "🌌⚔️"
    }
  },
  "finGifs": {
    "none": "assets/starwars/fin-aucun-image.jpg",
    "low": "assets/starwars/fin-bas-image.gif",
    "mid": "assets/starwars/fin-moyen-image.gif",
    "high": "assets/starwars/fin-haut-image.gif"
  },
  "finGifPos": {
    "none": "72% 62%",
    "low": "69% 50%",
  ...
  "finGifOverlay": {
    "none": "linear-gradient(to right, rgba(10,12,16,1) 0%, rgba(10,12,16,0.7) 45%, rgba(0,0,0,0) 50%, rgba(10,12,16,0.7) 95%, rgba(10,12,16,1) 100%)",
    "low": "linear-gradient(to right, rgba(10,12,16,1) 0%, rgba(10,12,16,0.9) 50%, rgba(0,0,0,1) 55%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0.95) 75%, rgba(10,12,16,0.9) 80%, rgba(10,12,16,1) 85%)",
    "mid": "linear-gradient(to right, rgba(10,12,16,1) 0%, rgba(10,12,16,0.9) 50%, rgba(0,0,0,1) 55%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0) 75%, rgba(0,0,0,0.9) 92%, rgba(10,12,16,1) 95%)",
    "high": "linear-gradient(to right, rgba(10,12,16,1) 0%, rgba(10,12,16,0.9) 45%, rgba(0,0,0,1) 50%, rgba(0,0,0,0.1) 60%, rgba(10,12,16,1) 100%)"
  },
  "finImage": "none",
  "finImagePos": "50% 50%",
  "finImageZoom": 100,
